...
To use, one can download the [snprecode](https://github.com/AMarete/fimpute-utils/raw/master/snprecode) standalone; change to executable: ```chmod a+x snprecode```; for full argument list run ```./snprecode -h```
